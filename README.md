...
| `update-manager` | Tray daemon that checks for flake updates (on demand or on a schedule), builds them on a branch with progress in the tray icon, and applies on request |
